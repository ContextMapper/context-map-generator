...
class ReadmeTest {
    ...
    void ex1m() throws IOException {
        ...
        Graphviz.fromGraph(g).width(200).render(Format.PNG).toFile(new File("graphviz-test-example/ex1m.png"));
        //## end
    }
    ...
    void ex1i() throws IOException {
        ...
        Graphviz.fromGraph(g).width(200).render(Format.PNG).toFile(new File("graphviz-test-example/ex1i.png"));
        //## end
    }
    ...
    void ex3() throws IOException {
        ...
        Graphviz.fromGraph(g).width(900).render(Format.PNG).toFile(new File("graphviz-test-example/ex3.png"));
        //## end
    }
    ...
    void ex4() throws IOException {
        ...
        Graphviz.fromGraph(g).width(700).render(Format.PNG).toFile(new File("graphviz-test-example/ex4-1.png"));
        ...
        Graphviz.fromGraph(g).width(700).render(Format.PNG).toFile(new File("graphviz-test-example/ex4-2.png"));
        //## end
    }
    ...
    void ex6() throws IOException {
        ...
        g.render(Format.PNG).toFile(new File("graphviz-test-example/ex6d.png"));
        g.fontAdjust(.87).render(Format.PNG).toFile(new File("graphviz-test-example/ex6a.png"));
        //## end
    }
    ...
    void ex7() throws IOException {
        ...
        g.basedir(new File("graphviz-test-example")).render(Format.PNG).toFile(new File("graphviz-test-example/ex7.png"));
        //## img
    }
    ...
    void ex8() throws IOException {
        ...
        g.basedir(new File("graphviz-test-example")).render(Format.PNG).toFile(new File("graphviz-test-example/ex8.png"));
        //## image
    }
}
